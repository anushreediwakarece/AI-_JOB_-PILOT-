...
| Job Discovery                  | JSearch API (RapidAPI)   | Job search and discovery                         |
...
│   └── api/
│       ├── agent/
│       │   ├── find/route.ts              → Trigger JSearch job discovery
...
├── agent/
│   ├── jsearch.ts                         → JSearch API job discovery + Gemini scoring
